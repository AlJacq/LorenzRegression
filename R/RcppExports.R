...
.PLR_derivative_cpp_m <- function(derz, y, ycum, X, pi, theta, h, gamma, kernel) {
    .Call('_LorenzRegression_PLR_derivative_cpp_m', PACKAGE = 'LorenzRegression', derz, y, ycum, X, pi, theta, h, gamma, kernel)
}
...
.PLR_loss_cpp_m <- function(lossz, X, y, ycum, pi, theta, h, gamma, kernel) {
    .Call('_LorenzRegression_PLR_loss_cpp_m', PACKAGE = 'LorenzRegression', lossz, X, y, ycum, pi, theta, h, gamma, kernel)
}
